 ...
 * @author reda-
 */
public class MessageExistingConnection implements Message {
     ...
     */
    public MessageExistingConnection(int id, String name) {
    ...
    @Override
    public Type getType() {
        return Type.EXISTING_CONNECTION;
    }
    ...
    public Object getContent() {
        return "Le client est déjà connecté";
    }
}
