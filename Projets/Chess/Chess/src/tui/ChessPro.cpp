...
std::pair<Position,Position> ChessPro::translateStrToPosi(std::string str)
{
    Position start;
    Position end;

    int startx =8-static_cast<int>(str.at(1))+48;  //+48 pour pas avoir ascii
    int starty =str.at(0)-'a';  //-a pour le rendre en int   ex: a = 65 donc 65-65=0
